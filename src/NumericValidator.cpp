...
/*!
Beim Pr�fen wird die Zeichenkette mit dem neuen Zeichen als Parameter
�bergeben. Wenn die Methode Invalid zur�ckgibt, wird das Zeichen nicht
in den LineEditor �bernommen.
